...
| `execution` | Pure phases over one input concept with ordered publication and stop policy; sequential native stack ceiling or bounded concurrent admission in the interpreter reference |
