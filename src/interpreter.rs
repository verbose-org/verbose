        ...
        Rule {
            ...
            proofs: Proofs {
                ...
                termination: Termination {
                    bound: Some(1),
                    structural: None, decreasing: None, increasing: None,
                },
            },
            hints: None,
            layer: None,
    ...
    fn division_by_zero_caught() {
        ...
        let rule = Rule {
            ...
            proofs: Proofs {
                ...
                termination: Termination { bound: Some(1), structural: None, decreasing: None, increasing: None },
            },
            hints: None,
            layer: None,
            context_name: None,
    ...
    fn if_else_evaluation() {
        ...
        let rule = Rule {
            ...
            proofs: Proofs {
                ...
                termination: Termination { bound: Some(3), structural: None, decreasing: None, increasing: None },
            },
            hints: None,
            layer: None,
            context_name: None,
    ...
    fn not_boolean() {
        ...
        let rule = Rule {
            ...
            proofs: Proofs {
                ...
                termination: Termination { bound: Some(2), structural: None, decreasing: None, increasing: None },
            },
            hints: None,
            layer: None,
            context_name: None,
    ...
    fn map_doubles_each_element() {
        ...
        let rule = Rule {
            ...
            proofs: Proofs {
                ...
                termination: Termination { bound: Some(10), structural: None, decreasing: None, increasing: None },
            },
            hints: None,
            layer: None,
            context_name: None,
    ...
    fn match_result_dispatches_on_tag() {
        ...
        let rule = Rule {
            ...
            proofs: Proofs {
                ...
                termination: Termination { bound: Some(20), structural: None, decreasing: None, increasing: None },
            },
            hints: None,
            layer: None,
            context_name: None,
    ...
    fn concat_builds_dynamic_text() {
        ...
        let rule = Rule {
            ...
            proofs: Proofs {
                ...
                termination: Termination { bound: Some(4), structural: None, decreasing: None, increasing: None },
            },
            hints: None,
            layer: None,
            context_name: None,
